...
n_minor_radius = 3 # 3 # 6 # number of minor radii for scan
r_min = 0.2 # minimum minor radius to use in meters (maximum radius usually 1.7044/1.4=1.22)
rminor_factor=1 # ratio between max minor radius to use and ARIES_CS minor radius
maximum_s_particle = 0.95 # maximum s value to integrate in gyronimo using vmectrace
ns_array = [16,51,101] # number of surfaces 
ftol_array = [1e-12,1e-14,1e-14]
niter_array = [1000,3000,3000]
surfaces_plot_qsc_vmec = 3
# Particle and Integration Properties
r_initial = 0.1  # meters
theta_initial = 0  # initial Boozer poloidal angle
varphi_initial = 0.3  # initial cylindrical toroidal angle
